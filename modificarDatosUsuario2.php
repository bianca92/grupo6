...
$var_consulta= "UPDATE persona SET IdPersona='$id', nombre='$nombre', apellido='$apellido', dni='$dni', telefono='$telefono', ciudad='$ciudad', email='$email', clave='$clave', fechaNacimiento='$nacimiento'  WHERE IdPersona='$id' ";
