...
$var_consulta= "SELECT idPersona FROM esperaclasico ORDER BY idEsperaC DESC";
...
?>
	<title>LISTA DE ESPERA PARA CLASICO</title>
	...
	<body>
		...
		<div id="wrapper" style="margin-left: 350px;margin-top: 0px;">
			...
			<form name="formulario" class="login-form" style="width:700px;background-color:#28a3db;">
				<div class="header">
					<h1> LISTA DE ESPERA PARA CLASICO</h1>
				</div>
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      $var_consulta2= "SELECT apellido, nombre, email FROM persona WHERE idPersona=$row[0]";
                         ...
                         <tr>
                           ...
                           <td><br><?php echo "<a href='aceptarUsuarioAClasico.php?idU=".$row['idPersona']."'> <button type='button' class='btn btn-succes'>ACEPTAR</button> </a></br>" ;?>  
                          <td><br><?php echo "<a href='rechazarUsuarioAClasico.php?idU=".$row['idPersona']."'> <button type='button' class='btn btn-succes'>RECHAZAR</button> </a></br>" ;?>  
                          </tr>
