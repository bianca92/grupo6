...
?>
	...
	<body>
		...
		<div id="wrapper" style="margin-left: 300px;margin-top: 0px;">

			
			<form name="formulario" class="login-form" style="width:800px;background-color:#28a3db;">
				<div class="header">
  ...
  <td ><?php echo "<p><font color='".$color."'>".$tercero."</font></p>";  ?></td>
   ...
   <td ></td>
    <td ></td>
                    ...
                    <?php   if($row['tipoU']=="premium"){ ?>

                              <td><br><?php echo "<a href='eliminarPremium.php?idU=".$row['IdPersona']."'> <button type='button' class='btn btn-succes'>Convertir a usuario comun</button> </a></br>" ;?>  
                              </tr>
                       <?php   } 
                        else{
                       ...
                       ?>
                           <td><br><?php echo "<a href='aceptarUsuario.php?idU=".$row['IdPersona']."'> <button type='button' class='btn btn-succes'>Hacer Premium</button> </a></br>" ;?>       
                          </tr>
